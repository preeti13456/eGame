...
<head>
    ...
    <title><?php echo e(config('app.name', 'eGame')); ?></title>
    <!-- Styles -->
    ...
    <div id="app">
        <nav class="navbar navbar-inverse bg-primary navbar-static-top"><!-- También se puede cambiar el navbar por navbar-default, navbar-dar, light, etc -->
            <div class="container">
                <div class="navbar-header">
                    ...
                    <!-- Branding Image -->
                    <a class="navbar-brand" href="<?php echo e(url('/')); ?>"><i class="fa fa-fw fa-home"></i>
                        eGame
                    </a> 
                </div>
                    ...
                    <ul class="nav navbar-nav navbar-left">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-content">
                                <a href="<?php echo e(action('ArticleController@showByPlatform', 'PS4')); ?>">PS4</a>
                                <a href="<?php echo e(action('ArticleController@showByPlatform', 'XBOX ONE')); ?>">XBOX ONE</a>
                                <a href="<?php echo e(action('ArticleController@showByPlatform', 'PC')); ?>">PC</a>
                                <a href="<?php echo e(action('ArticleController@showByPlatform', 'NINTENDO SWITCH')); ?>">NINTENDO SWITCH</a>
                                <a href="<?php echo e(action('ArticleController@showByPlatform', 'NINTENDO 3DS')); ?>">NINTENDO 3DS</a>
                                <a href="<?php echo e(action('ArticleController@showByPlatform', 'WII U')); ?>">WII U</a>
                                <a href="<?php echo e(action('ArticleController@showByPlatform', 'PS VITA')); ?>">PLAYSTATION VITA</a>
                            </div>
                        </div>
                    </ul>
                    <!-- Center Side Of Navbar -->
                    <div class="col-md-3" style="margin-left: 100px; margin-top: 13px;">
                        <form class="search" action="<?php echo e(action('MainController@search', 'search')); ?>" method="get">
                            <input list="articles" placeholder="Search a game..." name="search">
                            <datalist id="articles">
                                <?php $__currentLoopData = $articlesCollection; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($article->name); ?>"><?php echo e($article->name); ?></option>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-content">
                                    ...
                                    <?php else: ?>
                                        ...
                                        <a href="<?php echo e(route('user_orders')); ?>"
                                            title="Your Orders">
                                            Your Orders
                                        </a>
                                        <a href="<?php echo e(route('user_ratings')); ?>"
                                            title="Your Ratings">
                                            Your Ratings
                                        </a>
                                    <?php endif; ?>
        ...
        <div class="panel panel-default" id="advancedSearch">
            <div class="panel-heading">
                ...
                <form id="searchForm" action="<?php echo e(action('MainController@advancedSearch', 'advancedSearch')); ?>" method="get">
                    <div class="row">
                        <div class="col-md-2">
