...
<div class="container">
    ...
    <div class="panel panel-default">
        ...
        @endif
        {{ $articles->links() }} <!--With this method, we display the pager on the Articles page--> 
        <div class="floating">
            <a href="{{ route('articles.create') }}" class="btn btn-primary btn-fab">
                <i class="material-icons">add</i> <!-- We add the '+' icon with material design from googleapis.com-->
            </a>
        </div>
    </div>
</div>
