<div class="container text-center">
	<div class="card product text-left">
		@if(Auth::check() && Auth::user()->role == 'Admin') {{-- With this we check if the user has logged in and also has the Administrator role, in that case they will be given administrator permissions on the article--}}
